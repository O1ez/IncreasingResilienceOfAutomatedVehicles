...
class Model:
    ...
    def calc_tp_fp(self, path: str, step=""):
        ...
        first_unite = BDD.apply_operand(bdd_not_f, bdd_not_uo, not_f_vars)
        bdd_fp = BDD.apply_operand(bdd_f_replaced, first_unite, f_united_vars)
        ...
        bdd_tp = BDD.apply_operand(bdd_f_replaced, BDD.apply_operand(bdd_not_uo, self.f, self.vars), f_united_vars)
